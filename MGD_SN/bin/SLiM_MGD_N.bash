...
# Keywords : run neutral simulations SLiM bash constant MGD-N

# Run the MGD-N scenario pipeline
# Is part of the MGD scenario
# Run MGD_N-SIM.slim based on the contents of each id_sweep_parameters.txt files on the results/ folder
