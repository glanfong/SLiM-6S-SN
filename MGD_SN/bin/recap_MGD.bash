...
# Keywords : recap recapitation simulations SLiM bash ms MGD
...
# Step 2 : use trees2ms.py to recapitate the trees and create an ms output based on a "samp" number of individuals
    ...
    python3 ../../../bin/trees2ms_MGD.py selection=$1 id=${id} NeA=${NeA} NeB=${NeB} r=${r} mu=${mu} L=${L} m=${m} samp=${samp} chg_r=${chg_r} split_gen=${split_gen} chg_gen=${chg_gen}
