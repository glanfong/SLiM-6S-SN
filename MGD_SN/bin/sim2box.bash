...
# Keywords : sim2box png image picture simulations SLiM bash demographic change MGD
...
for id in $(ls *_parameters.txt | cut -d'_' -f1); do
	python3 ../../../bin/sim2box_single_YOLOv5.py dpi=${dpi} datapath=$(pwd) simulation=${id} object=posSelection;
