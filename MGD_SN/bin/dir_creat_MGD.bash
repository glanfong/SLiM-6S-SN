...
# Keywords : prior simulations SLiM bash creat demographic change MGD
# $1 = directory random id
...
mkdir "../sim/MGD-$PHDYEAR$MONTH$DAY-$1"
binpath=$(pwd)

cd ../sim/MGD-$PHDYEAR$MONTH$DAY-$1/
mkdir param
mkdir results
...
touch metadata
echo -e "id\tMGD-$PHDYEAR$MONTH$DAY-$1" >> metadata
